...
aproxl: main.o splines.o points.o aproksymator_na_bazie_Laguerre.o gaus/libge.a
	$(CC) -o aproxl main.o splines.o points.o aproksymator_na_bazie_Laguerre.o -L gaus -l ge
...
aproksymator_na_bazie_Laguerre.o: makespl.h points.h gaus/piv_ge_solver.h
	$(CC) -I gaus -c aproksymator_na_bazie_Laguerre.c
